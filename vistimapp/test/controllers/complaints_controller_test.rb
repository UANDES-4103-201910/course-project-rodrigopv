...
class ComplaintsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create complaint" do
    assert_difference('Complaint.count') do
      post complaints_url, params: { complaint: { author_id: @complaint.author_id, category_id: @complaint.category_id, content: @complaint.content, entity_id: @complaint.entity_id, title: @complaint.title } }
    end
  ...
  test "should update complaint" do
    patch complaint_url(@complaint), params: { complaint: { author_id: @complaint.author_id, category_id: @complaint.category_id, content: @complaint.content, entity_id: @complaint.entity_id, title: @complaint.title } }
